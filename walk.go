...
type WalkData struct {
	// Root is the parsed root of this STOP program
	Root ast.Node
...
// STOP program and call the callback cb to determine what to replace it
// with.
//
// This function is very useful for arbitrary STOP program interpolation
...
// with your typical configuration structures to STOPp mitigate the risk
// of panics.
